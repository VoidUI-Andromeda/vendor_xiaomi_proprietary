...
namespace android {
// ---------------------------------------------------------------------------
ANDROID_SINGLETON_STATIC_INSTANCE(MiDisplayDeviceManager);

MiDisplayDeviceManager::MiDisplayDeviceManager()
    :mMiDeviceFd(-1)
{
    ALOGD("%s", __func__);
...
int MiDisplayDeviceManager::setFeature(struct disp_feature_req *feature_req)
{
    int ret = -1;
...
int MiDisplayDeviceManager::setDozeBrightness(struct disp_doze_brightness_req *doze_req)
{
    int ret = -1;
...
int MiDisplayDeviceManager::getDozeBrightness(struct disp_doze_brightness_req *doze_req)
{
    int ret = -1;
...
int MiDisplayDeviceManager::getPanelInfo(struct disp_panel_info *panel_info_req)
{
    int ret = -1;
...
int MiDisplayDeviceManager::getWPInfo(struct disp_wp_info *wp_info_req)
{
    int ret = -1;
...
int MiDisplayDeviceManager::getFPS(struct disp_fps_info *fps_info_req)
{
    int ret = -1;
...
int MiDisplayDeviceManager::registerEvent(struct disp_event_req *event_req)
{
    int ret = -1;
...
int MiDisplayDeviceManager::deRegisterEvent(struct disp_event_req *event_req)
{
    int ret = -1;
...
int MiDisplayDeviceManager::writeDsiCmd(struct disp_dsi_cmd_req* dsi_cmd_req)
{
    int ret = -1;
