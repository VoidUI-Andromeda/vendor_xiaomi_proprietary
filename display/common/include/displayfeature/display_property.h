...
#define PERSIST_VENDOR_VIDEO_DFPS_LEVEL       "persist.vendor.video.dfps.level"
#define PERSIST_VENDOR_VIDEO_DFPS             "persist.vendor.video.dfps"
#define VENDOR_THERMAL_DFPS_LEVEL             "vendor.displayfeature.thermal.dfps.level"
