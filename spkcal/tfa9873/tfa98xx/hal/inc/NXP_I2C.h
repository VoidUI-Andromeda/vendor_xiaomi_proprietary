 ...
 */
/** * @defgroup HAL target interface abstraction (NXP_I2C hal)
 * @{
*/
 ...
 *  @return NXP_I2C_Error_t enum
 */
int NXP_I2C_SetPin(int pin, int value);
 ...
 *
 */
NXP_I2C_Error_t NXP_TFADSP_Execute(int slave, int command_length, void *command_buffer,
					 int result_length, void *result_buffer);
/**
 * Call remote tfadsp_init()
 *
 */
NXP_I2C_Error_t NXP_TFADSP_Init(int slave, void *buffer, int length);
/** @} */
#ifdef __cplusplus
}
#endif
