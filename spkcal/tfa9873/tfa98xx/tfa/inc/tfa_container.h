...
*/
char *tfa_cont_get_tfahal(tfaContainer_t *cnt, tfaDescPtr_t *dsc);
 ...
 */
int tfa_cnt_has_haptic_9914(struct tfa_device *tfa) ;
...
*/
int tfaContGetMainProfile(struct tfa_device *tfa);
...
/**
* Retrieve the number of devices in the container file
* @param cnt pointer to the start of the buffer holding the container file
* @param ndev number of devices in the container file
* @return tfa_error_ok if normal
* @return tfa_error_container invalid container data
*/
enum tfa_error tfa_cnt_get_devices(void *cnt, int *ndev);
