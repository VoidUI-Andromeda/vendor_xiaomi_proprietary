...
//++ MTP_TEST
int tfa_save_mtp_buffer(struct tfa_device *tfa, int *pMtp_Buffer);
int tfa_compare_mtp_content(struct tfa_device *tfa,int origb[] ,int newb[]);
int tfa_check_mtp_patterns(struct tfa_device *tfa,int newb[],uint16_t pattern_to_check);
//-- MTP_TEST
