...
/* */
/* TFA9914 haptic firmware constants */
#define FW_XMEM_CMDOBJSEL0	500
#define FW_XMEM_SAMPCNT0	502
#define FW_XMEM_CMDOBJSEL1	504
#define FW_XMEM_SAMPCNT1	506
#define FW_XMEM_F0		13  /* fResOut */
#define FW_XMEM_R0		12  /* Rf0Out */
#define FW_XMEM_GENOBJECTS	20
#define FW_XMEM_OBJECTSIZE	 8
#define FW_HB1_MAX_OBJECTS	 34
#define FW_HB1_CAL_OBJ (FW_HB1_MAX_OBJECTS-1)
#define FW_XMEM_FEATUREID_OFFSET 0
#define FW_XMEM_FREQ_OFFSET      1
#define FW_XMEM_LEVEL_OFFSET     2
#define FW_XMEM_SAMPLES_OFFSET   3
#define FW_XMEM_TRACKER_OFFSET   5
#define FW_XMEM_R0_MAX 557
#define FW_XMEM_R0_MIN 558
#define FW_XMEM_F0_MAX 559
#define FW_XMEM_F0_MIN 660
#define FW_XMEM_F0_R0_RANGES 557
#define FW_XMEMADDR_OBJ_SEQUENCE	300
